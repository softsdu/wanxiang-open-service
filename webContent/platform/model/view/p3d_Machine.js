viewModels.p3d_Machine = {
  id:"495affe8-9391-4793-8eaf-119be70951c6",
  name:"p3d_Machine",
  dataName:"p3d_Machine",
  title:"物理机",
  colModel:[
    ...
    {name:"datacenterid", label:"所属数据中心id", width:0, hidden:true, sortable:false, search:false, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"datacentername", label:"所属数据中心", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"pop"},
  ...
  dispUnitModel:[
    ...
    {name:"datacenterid", label:"所属数据中心id", editable:true,nullable:true, hidden:true, dispunitType:"text", },
    {name:"datacentername", label:"所属数据中心", editable:true,nullable:true, hidden:false, dispunitType:"pop", },
