viewModels.con_BlueprintLegend = {
  id:"d9972f80-1b20-46e3-bfb1-bec6156ed62c",
  name:"con_BlueprintLegend",
  dataName:"con_BlueprintLegend",
  title:"蓝图图例",
  colModel:[
    ...
    {name:"fileid", label:"关联文件ID", width:200, hidden:true, sortable:false, search:false, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"fileid", label:"关联文件ID", editable:true,nullable:true, hidden:true, dispunitType:"text", },
