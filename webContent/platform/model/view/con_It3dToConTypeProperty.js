viewModels.con_It3dToConTypeProperty = {
  id:"bffb3bdb-477d-402b-8ec0-b81afd255f9a",
  name:"con_It3dToConTypeProperty",
  dataName:"con_It3dToConTypeProperty",
  title:"IT3D组件类型属性和构件类型属性对照",
  colModel:[
    ...
    {name:"it3dpropertyname", label:"IT3D属性名", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, align:'left', canEdit:true, nullable:false, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"it3dpropertyname", label:"IT3D属性名", editable:true,nullable:false, hidden:false, dispunitType:"text", },
