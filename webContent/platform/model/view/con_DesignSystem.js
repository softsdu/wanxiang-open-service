viewModels.con_DesignSystem = {
  id:"0db0f488-0dd6-4b22-96b8-0e11f2d1c76c",
  name:"con_DesignSystem",
  dataName:"con_DesignSystem",
  title:"设计系统信息",
  colModel:[
    ...
    {name:"versionnum", label:"版本", width:80, hidden:false, sortable:false, search:false, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
