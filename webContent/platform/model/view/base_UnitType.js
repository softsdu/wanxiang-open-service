viewModels.base_UnitType = {
  id:"2ece8576-b143-4a8d-b488-b4bfd300f1c6",
  name:"base_UnitType",
  dataName:"base_UnitType",
  title:"计量单位",
  colModel:[
    ...
    {name:"shortname", label:"简写", width:100, hidden:false, sortable:false, search:false, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"shortname", label:"简写", editable:true,nullable:true, hidden:false, dispunitType:"text", },
