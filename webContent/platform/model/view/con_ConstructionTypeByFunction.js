viewModels.con_ConstructionTypeByFunction = {
  id:"1fd69960-1283-4ce3-a704-3517966061b4",
  name:"con_ConstructionTypeByFunction",
  dataName:"con_ConstructionTypeByFunction",
  title:"建筑物类型（按功能）",
  colModel:[
    ...
    {name:"code", label:"编码", width:200, hidden:false, sortable:false, search:false, resizable:true, editable:true, align:'left', canEdit:true, nullable:false, edittype:"text", dispunitType:"text"},
    {name:"name", label:"名称", width:200, hidden:false, sortable:false, search:false, resizable:true, editable:true, align:'left', canEdit:true, nullable:false, edittype:"text", dispunitType:"text"},
    ...
    {name:"isleaf", label:"isleaf", width:0, hidden:true, sortable:false, search:false, resizable:true, editable:true, align:'center', canEdit:false, nullable:true, edittype:"checkbox", dispunitType:"checkbox"},
  ...
  dispUnitModel:[
    ...
    {name:"isleaf", label:"isleaf", editable:false,nullable:true, hidden:true, dispunitType:"checkbox", }
  ]
}
