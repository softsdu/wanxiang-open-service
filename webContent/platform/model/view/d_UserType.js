viewModels.d_UserType = {
  id:"be29b89c-5c16-4d84-a72f-180aafc5f37b",
  name:"d_UserType",
  dataName:"d_UserType",
  colModel:[
    ...
    {name:"code", label:"编码", width:200, hidden:false, sortable:false, search:true, resizable:true, editable:true, align:'left', canEdit:true, nullable:false, edittype:"text", dispunitType:"text"},
