viewModels.std_Standard = {
  id:"5ea54bfb-7d2d-46ba-8c46-1de98e0d2a88",
  name:"std_Standard",
  dataName:"std_Standard",
  title:"标准",
  colModel:[
    ...
    {name:"code", label:"编码", width:300, hidden:false, sortable:true, search:true, resizable:true, editable:true, align:'left', canEdit:true, nullable:false, edittype:"text", dispunitType:"text"},
