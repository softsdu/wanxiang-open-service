viewModels.p3d_Container = {
  id:"c61d92ef-7293-48ce-9fb9-e6fd8002f72e",
  name:"p3d_Container",
  dataName:"p3d_Container",
  title:"容器",
  colModel:[
    ...
    {name:"containertype", label:"容器类型", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"list"},
    {name:"podid", label:"podid", width:0, hidden:true, sortable:false, search:false, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"podname", label:"所属容器组", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"pop"},
  ...
  dispUnitModel:[
    ...
    {name:"containertype", label:"容器类型", editable:true,nullable:true, hidden:false, dispunitType:"list", },
    {name:"podid", label:"podid", editable:true,nullable:true, hidden:true, dispunitType:"text", },
    {name:"podname", label:"所属容器组", editable:true,nullable:true, hidden:false, dispunitType:"pop", },
