viewModels.mdl_Model = {
  id:"c0d91430-b195-4c5c-977d-641cf1b8dcea",
  name:"mdl_Model",
  dataName:"mdl_Model",
  title:"BIM云模型",
  colModel:[
    ...
    {name:"accessoryid", label:"附件Id", width:0, hidden:true, sortable:false, search:false, resizable:false, editable:true, align:'left', canEdit:false, nullable:false, edittype:"text", dispunitType:"text"},
    ...
    {name:"companyname", label:"所属公司", width:200, hidden:false, sortable:false, search:false, resizable:true, editable:true, align:'left', canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"accessoryid", label:"附件Id", editable:false,nullable:false, hidden:true, dispunitType:"text", },
