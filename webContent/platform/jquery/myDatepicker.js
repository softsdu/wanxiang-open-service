...
function() {
    ...
    var t, S = (function(t, i) {
        t.exports = function() {
            ...
            function l(t) {
                ...
                e = Array(1 < i ? i - 1 : 0), o = 1; o < i; o++) e[o - 1] = arguments[o];
            ...
            function D(t) {
                ...
                function a() { (s = document.createEvent("Event")).initEvent(i, n, r),
                    l(s, o)
                }
            ...
            function _(t, i, e, o, s, n, r) {
                ...
                f < o ? (f = n ? Math.max(o - n / 4, o - n / m * l) : o, u = d) : s < f && (f = n ? Math.min(s + n / 4, s + n / m * l) : s, u = d),
                {
            ...
            function E() {}
            var k, L, O, P, H, I = e ? window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame ||
            function(t) {
                return window.setTimeout(t, (t.interval || 100 / 60) / 2)
            }: E,
            z = e ? window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame ||
            function(t) {
            ...
            k.prototype.refresh = function() {
                ...
                o ? (this.items = this.scroller.children, this.options.itemHeight = this.itemHeight = this.items.length ? this.scrollerHeight / this.items.length: 0, void 0 === this.selectedIndex && (this.selectedIndex = o.selectedIndex || 0), this.options.startY = -this.selectedIndex * this.itemHeight, this.maxScrollX = 0, this.maxScrollY = -this.itemHeight * (this.items.length - 1)) : (this.maxScrollX = this.wrapperWidth - this.scrollerWidth, this.options.infinity || (this.maxScrollY = this.wrapperHeight - this.scrollerHeight), this.maxScrollX < 0 ? (this.maxScrollX -= this.relativeX, this.minScrollX = -this.relativeX) : 1 < this.scale && (this.maxScrollX = this.maxScrollX / 2 - this.relativeX, this.minScrollX = this.maxScrollX), this.maxScrollY < 0 ? (this.maxScrollY -= this.relativeY, this.minScrollY = -this.relativeY) : 1 < this.scale && (this.maxScrollY = this.maxScrollY / 2 - this.relativeY, this.minScrollY = this.maxScrollY)),
            ...
            L.prototype._move = function(t) {
                if (this.enabled && !this.destroyed && T[t.type] === this.initiated) {
                    ...
                    if (! (r - this.endTime > this.options.momentumLimitTime && n < this.options.momentumLimitDistance && s < this.options.momentumLimitDistance)) {
                        ...
                        d = !1,
                        p = !1,
                        u = this.options.bounce; ! 1 !== u && (h = void 0 === u.top || u.top, c = void 0 === u.bottom || u.bottom, d = void 0 === u.left || u.left, p = void 0 === u.right || u.right),
            ...
            L.prototype._checkClick = function(t) {
                ...
                return this.options.tap && (i = t, e = this.options.tap, (o = document.createEvent("Event")).initEvent(e, !0, !0), o.pageX = i.pageX, o.pageY = i.pageY, i.target.dispatchEvent(o)),
            ...
            L.prototype._translate = function(t, i, e) {
                ...
                } (!c(t) && !c(i)), c(e) && (e = this.scale), this.options.useTransform ? this.scrollerStyle[x.transform] = "translate(" + t + "px," + i + "px) scale(" + e + ")" + this.translateZ: (t = Math.round(t), i = Math.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.options.wheel) for (var o = this.options.wheel.rotate,
                s = void 0 === o ? 25 : o, n = 0; n < this.items.length; n++) {
            ...
            L.prototype.resetPosition = function() {
                ...
                e = this.x,
                o = Math.round(e); ! this.hasHorizontalScroll || o > this.minScrollX ? e = this.minScrollX: o < this.maxScrollX && (e = this.maxScrollX);
                var s = this.y,
                n = Math.round(s);
            ...
            H.prototype._onMouseWheel = function(t) {
                ...
                if (this.enabled) {
                    ...
                    c = void 0;
                    switch (!0) {
                    case "deltaX" in t: c = 1 === t.deltaMode ? (h = -t.deltaX * s, -t.deltaY * s) : (h = -t.deltaX, -t.deltaY);
                        break;
                    case "wheelDeltaX" in t: h = t.wheelDeltaX / 120 * s,
                        c = t.wheelDeltaY / 120 * s;
                        break;
                    case "wheelDelta" in t: h = c = t.wheelDelta / 120 * s;
                        break;
                    case "detail" in t: h = c = -t.detail / 3 * s;
                        break;
                    default:
                        return
                    }
    ...
    function i() {
        ...
        e = void 0;
        if (i.extend(t), t.el) {
            if (! (e = i.$(t.el)) || e.bindRolldate) return;
            e.bindRolldate = 1,
            i.tap(e,
            function() {
                i.show()
    ...
    return i.prototype = {
        ...
        extend: function(t) {
            ...
            for (var e in i) if (i[e] && "[object Object]" == Object.prototype.toString.call(i[e])) for (var o in t[e]) i[e][o] = null == t[e][o] ? i[e][o] : t[e][o];
            else i[e] = t[e] || i[e];
            this.config = i
        },
        createUI: function() {
            for (var n = this,
            t = n.baseData(), r = n.config, a = t.domId, l = r.format.split(/-|\/|\s|:/g), i = l.length, e = "", h = r.el ? n.$(r.el).bindDate || new Date: n.bindDate || new Date, c = r.lang, o = 0; o < i; o++) {
                var s = l[o],
                d = 0;
                ...
                d++;
                else if ("MM" == s) for (var u = 1; u <= 12; u++) e += '<li class="wheel-item ' + (u == h.getMonth() + 1 ? "active": "") + '" data-index="' + d + '">' + (u < 10 ? "0" + u: u) + c.month + "</li>",
                d++;
                else if ("DD" == s) for (var m = n.bissextile(h.getFullYear(), h.getMonth() + 1), f = 1; f <= m; f++) e += '<li class="wheel-item ' + (f == h.getDate() ? "active": "") + '" data-index="' + d + '">' + (f < 10 ? "0" + f: f) + c.day + "</li>",
                d++;
                else if ("hh" == s) for (var v = 0; v <= 23; v++) e += '<li class="wheel-item ' + (v == h.getHours() ? "active": "") + '" data-index="' + d + '">' + (v < 10 ? "0" + v: v) + c.hour + "</li>",
                d++;
                else if ("mm" == s) for (var g = 0; g <= 59; g += r.minStep) e += '<li class="wheel-item ' + (g == h.getMinutes() ? "active": "") + '" data-index="' + d + '">' + (g < 10 ? "0" + g: g) + c.min + "</li>",
                d++;
                else if ("ss" == s) for (var w = 0; w <= 59; w++) e += '<li class="wheel-item ' + (w == h.getSeconds() ? "active": "") + '" data-index="' + d + '">' + (w < 10 ? "0" + w: w) + c.sec + "</li>",
                d++;
                e += "</ul></div>"
            }
            ...
            for (var x = function(t) {
                ...
                function() {
                    if (r.moveEnd && r.moveEnd.call(n, o), -1 != [a.YYYY, a.MM].indexOf(o.wrapper.id) && n.scroll.YYYY && n.scroll.MM && n.scroll.DD) {
                        ...
                        var t = n.bissextile(n.getSelected(n.scroll.YYYY), n.getSelected(n.scroll.MM)),
                        i = "";
                        if (t != n.$("#" + a.DD + " li", 1).length) {
                            for (var e = 1; e <= t; e++) i += '<li class="wheel-item">' + (e < 10 ? "0" + e: e) + c.day + "</li>";
                            n.$("#" + a.DD + " ul").innerHTML = i,
                            n.scroll.DD.refresh()
                        }
                    }
                })
            ...
            T = 0; T < i; T++) x(T);
            n.$(".rolldate-panel").className = "rolldate-panel fadeIn"
        },
        $: function(t, i) {
        ...
        tap: function(t, e) {
            if ("ontouchstart" in window && "tap" == this.config.trigger) {
                ...
                function(t) {
                    ...
                    o.endX = i.pageX,
                    o.endY = i.pageY,
                    +new Date - o.sTime < 300 && Math.abs(o.endX - o.startX) + Math.abs(o.endY - o.startY) < 20 && (t.preventDefault(), e.call(this, t)),
                    o = {}
                })
        ...
        show: function() {
            ...
            e = void 0;
            if (i.el) {
                if (! (e = t.$(i.el)).bindRolldate) return;
                "input" == e.nodeName.toLowerCase() && e.blur()
            }
            t.$(".rolldate-container") || i.init && !1 === i.init.call(t) || (t.createUI(), t.event())
        },
        hide: function(t) {
        ...
        event: function() {
            ...
            function() {
                ...
                t.el ? ("input" == (i = a.$(t.el)).nodeName.toLowerCase() ? i.value = e: i.innerText = e, i.bindDate = o) : a.bindDate = o,
                a.hide()
            })
        },
