		...
		<div class="zlpCardStyleInnerContainer">
			<div class="zlpToolbarContainer">
				<div class="zlpToolbarLeftContainer"> 
					...
					<a href="#" id="updateRuntimeModelBtn" class="zlpToolbarBtn">生成JS模型</a>
				</div> 
			</div>
				...
				<div class="zlpCardMainContainer">
					<table class="zlpCardMainTable">
						<tr style="height:35px;">
							...
							<td class="zlpDispUnitTitle" style="width:100px;text-align:right;">启用</td>
							<td class="zlpDispUnitValue" style="width:200px;"><input type="checkbox" name="isusing" class="zlpDispUnitInput" style="width:150px;" cardCtrl="true"></input></td>
						</tr>  
						<tr style="height:35px;">
							<td class="zlpDispUnitTitle" style="width:100px;text-align:right;">类型</td>
							<td class="zlpDispUnitValue" style="width:200px;"><input type="text" name="dstype" class="zlpDispUnitInput" style="width:150px;" cardCtrl="true"></input></td> 
							<td class="zlpDispUnitTitle" style="width:100px;text-align:right;">所属模块</td>
							<td class="zlpDispUnitValue" colspan="3" style="width:500px;"><input type="text" name="sysmodule" class="zlpDispUnitInput" style="width:320px;" cardCtrl="true"></input></td>  
						</tr>  
						<tr style="height:60px;">
							<td class="zlpDispUnitTitle" style="text-align:right;">源表达式</td>
							<td class="zlpDispUnitValue" colspan="5"><textarea name="dsexp" class="zlpDispUnitInput" style="width:628px;height:50px;" cardCtrl="true"></textarea></td> 
						</tr> 
					</table>
				</div>
