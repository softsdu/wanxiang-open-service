...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/mdl_View.js"></script>
	<script type="text/javascript" src="${viewModel}/mdl_View.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			multiselect: false,  
			dataModel: dataModels.mdl_View,
			onePageRowCount: 20, 
			viewModel: viewModels.mdl_View 
		};
