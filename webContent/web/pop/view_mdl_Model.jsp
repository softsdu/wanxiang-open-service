...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/mdl_Model.js"></script>
	<script type="text/javascript" src="${viewModel}/mdl_Model.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			multiselect: false,  
			dataModel: dataModels.mdl_Model,
			onePageRowCount: 20, 
			viewModel: viewModels.mdl_Model 
		};
