...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/base_PropertyType.js"></script>
	<script type="text/javascript" src="${viewModel}/base_PropertyType.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			multiselect: false,  
			dataModel: dataModels.base_PropertyType,
			onePageRowCount: 20, 
			viewModel: viewModels.base_PropertyType 
		};
