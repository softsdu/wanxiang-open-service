...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/res_Gltf.js"></script>
	<script type="text/javascript" src="${viewModel}/res_Gltf.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			multiselect: false,  
			dataModel: dataModels.res_Gltf,
			onePageRowCount: 20, 
			viewModel: viewModels.res_Gltf,
			
			//修改过滤条件 modified by ls 20230828
			sysWhere: [{parttype:"field", field:"filetype", operator:"=", value: "gltfZip"}]
		};
