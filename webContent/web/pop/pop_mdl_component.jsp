...
<head>
	...
	<script type="text/javascript" src="${viewModel}/mdl_Component.js"></script>
	...
	<script>
		$(document).ready(function(){
			...
			var p = {
				...
				onePageRowCount: 20,
				viewModel: viewModels.mdl_Component,
				sysWhere:initParam.otherValues?initParam.otherValues:[],//通过otherValues属性传值过来
			};
