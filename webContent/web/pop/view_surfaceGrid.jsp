...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/mdl_Surface.js"></script>
	<script type="text/javascript" src="${viewModel}/mdl_Surface.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			multiselect: false,  
			dataModel: dataModels.mdl_Surface,
			onePageRowCount: 20, 
			viewModel: viewModels.mdl_Surface 
		};
