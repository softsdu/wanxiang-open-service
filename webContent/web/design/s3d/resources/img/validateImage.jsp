...
<head>
	...
	<script type="text/javascript" src="js/validateImage.js"></script>
</head>
<body>
			...
			<div style="position:absolute;left:100px;right:100px;height:100%;" id = "testGridContainer">
				<div class="createFileNavigator" id="createFileNavigatorId">
					<div class="createFileTitleDiv">
						<span class="createFileTitle">第二步: 完成上传Image文件</span>
						<a class="createFileBackToBegin" href="importImage.jsp">返回到第一步</a>
					</div>
					<div class="fileInfoContainerDiv" id="fileInfoContainerDivId">
						<div class="processStatusDiv">正在检测导入任务</div>
					</div>
				</div>
			</div>
		</div>
