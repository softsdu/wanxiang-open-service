...
let S3dPropertyList = function () {
  ...
  //隐藏
  this.hide = function () {
    $("#" + thatS3dPropertyList.containerId).find(".s3dPropertyListContainer").css({
      "display": "none"
    });
  };
  ...
  this.getListHtml = function () {
    return "<div class=\"s3dPropertyListContainer\">" + "<div class=\"s3dPropertyListBackground\"></div>" + "<div class=\"s3dPropertyListHeader\">" + "<div class=\"s3dPropertyListTitle\"></div>" + "<div class=\"s3dPropertyListSubTitle\"></div>" + "<div class=\"s3dPropertyListCloseBtn\">×</div>" + "</div>" + "<div class=\"s3dPropertyListInnerContainer\">" + "</div>" + "</div>";
  };
  ...
  this.refreshProperties = function (nodeJArray) {
    ...
    if (nodeJArray == null || nodeJArray.length === 0) {
      ...
      comParameters = thatS3dPropertyList.manager.s3dObject.objectTypeMap[nodeJson.code + "_" + nodeJson.versionNum].parameters;
  ...
  this.getPropertyHtml = function (paramName, paramValue) {
    return "<div class=\"s3dPropertyListItemContainer\">" + "<div class=\"s3dPropertyListItemTitle\">" + cmnPcr.htmlEncode(paramName) + "</div>" + "<div class=\"s3dPropertyListItemValue\">" + cmnPcr.htmlEncode(paramValue) + "</div>" + "</div>";
  };

  //获取group html
  this.getGroupHtml = function (groupName) {
    return "<div class=\"s3dPropertyListItemContainer\">" + "<div class=\"s3dPropertyListItemGroup\">" + cmnPcr.htmlEncode(groupName) + "</div>" + "</div>";
  };
};

export { S3dPropertyList as default };
