import { Color, MeshStandardMaterial, FrontSide, LineBasicMaterial, DoubleSide, Float32BufferAttribute, SphereGeometry, Mesh, BufferGeometry, Line } from '../../node_modules/three/build/three.module.js';
import { cmnPcr } from '../../commonjs/common/common.js';
import './s3dPointSelector.css.js';
...
let S3dPointSelector = function () {
  ...
  this.pointCount = 1;
  this.fixNum = 2;
  this.placedPointColor = new Color(0xff0000);
  this.waitingPlaceBallMaterial = new MeshStandardMaterial({
    color: 0xFF6A00,
    depthTest: false,
    flatShading: false,
    side: FrontSide,
        ...
        case "ruler":
          {
            for (let i = 0; i < pointArray.length; i++) {
              ...
              points.push({
                index: i,
                x: common3DFunction.v2s(cmnPcr.strToDecimal(point[0]), thatS3dPointSelector.manager.viewer.distanceRatio),
                y: 0,
                z: common3DFunction.v2s(cmnPcr.strToDecimal(point[1]), thatS3dPointSelector.manager.viewer.distanceRatio)
              });
            }
            break;
          }
        ...
        case "polyline3D":
          {
            for (let i = 0; i < pointArray.length; i++) {
              ...
              points.push({
                index: i,
                x: common3DFunction.v2s(cmnPcr.strToDecimal(point[0]), thatS3dPointSelector.manager.viewer.distanceRatio),
                y: common3DFunction.v2s(cmnPcr.strToDecimal(point[1]), thatS3dPointSelector.manager.viewer.distanceRatio),
                z: common3DFunction.v2s(cmnPcr.strToDecimal(point[2]), thatS3dPointSelector.manager.viewer.distanceRatio)
              });
            }
            break;
          }
      ...
      if (waitingPlacePoint != null) {
        ...
        if (waitingPlacePoint.isNew) {
          ...
          if (waitingPlaceLine != null) {
            ...
            waitingPlaceLine.geometry.setAttribute("position", new Float32BufferAttribute(positions, 3));
          ...
          if (preLine != null) {
            ...
            positions.push(beginPoint.position.x, beginPoint.position.y, beginPoint.position.z);
            positions.push(endPoint.position.x, endPoint.position.y, endPoint.position.z);
            preLine.geometry.setAttribute("position", new Float32BufferAttribute(positions, 3));
          ...
          if (nextLine != null) {
            ...
            positions.push(beginPoint.position.x, beginPoint.position.y, beginPoint.position.z);
            positions.push(endPoint.position.x, endPoint.position.y, endPoint.position.z);
            nextLine.geometry.setAttribute("position", new Float32BufferAttribute(positions, 3));
  ...
  this.getDisplayValueStr = function (sourceValue, fixNum) {
    ...
    return cmnPcr.decimalToStr(common3DFunction.s2v(sourceValue, thatS3dPointSelector.manager.viewer.distanceRatio), false, fixNum, true);
  };
  this.createPointBall = function (position) {
    let ballGeometry = new SphereGeometry(thatS3dPointSelector.placePointRadius, 16, 16);
    let ball = new Mesh(ballGeometry, thatS3dPointSelector.waitingPlaceBallMaterial);
  ...
  this.createWaitingPlaceLine = function (beginPoint, endPoint) {
    ...
    let line = new Line(geometry, thatS3dPointSelector.lineMaterial);
  ...
  this.getPoint3DListHtml = function (p) {
    return "<div class=\"s3dPointSelectorContainer\">" + "<div class=\"s3dPointSelectorBackground\"></div>" + "<div class=\"s3dPointSelectorHeader\">" + "<div class=\"s3dPointSelectorTitle\"></div>" + "<div class=\"s3dPointSelectorSubTitle\"></div>" + "<div class=\"s3dPointSelectorBtn s3dPointSelectorCloseBtn\" title=\"关闭\">×</div>" + "<div class=\"s3dPointSelectorHeaderItemContainer\">" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemIndex\">&nbsp;</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemX\">X</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemY\">Y</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemZ\">Z</div>" + "</div>" + "</div>" + "<div class=\"s3dPointSelectorInnerContainer\">" + "</div>" + "<div class=\"s3dPointSelectorBottomContainer\">" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnClear\">重新选点</div>" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnCancel\">取&nbsp;&nbsp;消</div>" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnOk\">确&nbsp;&nbsp;定</div>" + "</div>" + "</div>";
  };
  this.getPoint2DListHtml = function (p) {
    return "<div class=\"s3dPointSelectorContainer\">" + "<div class=\"s3dPointSelectorBackground\"></div>" + "<div class=\"s3dPointSelectorHeader\">" + "<div class=\"s3dPointSelectorTitle\"></div>" + "<div class=\"s3dPointSelectorSubTitle\"></div>" + "<div class=\"s3dPointSelectorBtn s3dPointSelectorCloseBtn\" title=\"关闭\">×</div>" + "<div class=\"s3dPointSelectorHeaderItemContainer\">" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemIndex\">&nbsp;</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemX\" style=\"width:75px;\">X</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemZ\" style=\"width:75px;\">Y</div>" + "</div>" + "</div>" + "<div class=\"s3dPointSelectorInnerContainer\">" + "</div>" + "<div class=\"s3dPointSelectorBottomContainer\">" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnClear\">重新选点</div>" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnCancel\">取&nbsp;&nbsp;消</div>" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnOk\">确&nbsp;&nbsp;定</div>" + "</div>" + "</div>";
  };
  this.getMixPoint2DListHtml = function (p) {
    return "<div class=\"s3dPointSelectorContainer\">" + "<div class=\"s3dPointSelectorBackground\"></div>" + "<div class=\"s3dPointSelectorHeader\">" + "<div class=\"s3dPointSelectorTitle\"></div>" + "<div class=\"s3dPointSelectorSubTitle\"></div>" + "<div class=\"s3dPointSelectorBtn s3dPointSelectorCloseBtn\" title=\"关闭\">×</div>" + "<div class=\"s3dPointSelectorHeaderItemContainer\">" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemIndex\">&nbsp;</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemX\" style=\"width:50px;\">X</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemZ\" style=\"width:50px;\">Y</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemBezier\" style=\"width:50px;\">曲线</div>" + "</div>" + "</div>" + "<div class=\"s3dPointSelectorInnerContainer\">" + "</div>" + "<div class=\"s3dPointSelectorBottomContainer\">" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnClear\">重新选点</div>" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnCancel\">取&nbsp;&nbsp;消</div>" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnOk\">确&nbsp;&nbsp;定</div>" + "</div>" + "</div>";
  };
  this.getGisPoint2DListHtml = function (p) {
    return "<div class=\"s3dPointSelectorContainer\">" + "<div class=\"s3dPointSelectorBackground\"></div>" + "<div class=\"s3dPointSelectorHeader\">" + "<div class=\"s3dPointSelectorTitle\"></div>" + "<div class=\"s3dPointSelectorSubTitle\"></div>" + "<div class=\"s3dPointSelectorBtn s3dPointSelectorCloseBtn\" title=\"关闭\">×</div>" + "<div class=\"s3dPointSelectorHeaderItemContainer\">" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemIndex\">&nbsp;</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemX\" style=\"width:75px;\">经度</div>" + "<div class=\"s3dPointSelectorHeaderItemCell s3dPointSelectorHeaderItemZ\" style=\"width:75px;\">纬度</div>" + "</div>" + "</div>" + "<div class=\"s3dPointSelectorInnerContainer\">" + "</div>" + "<div class=\"s3dPointSelectorBottomContainer\">" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnClear\">全部清除</div>" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnCancel\">取&nbsp;&nbsp;消</div>" + "<div class=\"s3dPointSelectorBottomBtn s3dPointSelectorBtnOk\">确&nbsp;&nbsp;定</div>" + "</div>" + "</div>";
  };
  ...
  this.getPoint3DItemHtml = function (p) {
    ...
    let y = thatS3dPointSelector.getDisplayValueStr(p.point.y);
    let z = thatS3dPointSelector.getDisplayValueStr(p.point.z);
    return "<div class=\"s3dPointSelectorItemContainer\">" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemIndex\" index=\"" + p.index + "\">" + (p.index + 1) + ".</div>" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemX\">" + x + "</div>" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemY\">" + y + "</div>" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemZ\">" + z + "</div>" + "</div>";
  };
  this.getPoint2DItemHtml = function (p) {
    let x = thatS3dPointSelector.getDisplayValueStr(p.point.x);
    let z = thatS3dPointSelector.getDisplayValueStr(p.point.z);
    return "<div class=\"s3dPointSelectorItemContainer\">" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemIndex\" index=\"" + p.index + "\">" + (p.index + 1) + ".</div>" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemX\" style=\"width:75px;\">" + x + "</div>" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemZ\" style=\"width:75px;\">" + z + "</div>" + "</div>";
  };
  this.getMixPoint2DItemHtml = function (p) {
    let x = thatS3dPointSelector.getDisplayValueStr(p.point.x);
    let z = thatS3dPointSelector.getDisplayValueStr(p.point.z);
    return "<div class=\"s3dPointSelectorItemContainer\">" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemIndex\" index=\"" + p.index + "\">" + (p.index + 1) + ".</div>" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemX\" style=\"width:50px;\">" + x + "</div>" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemZ\" style=\"width:50px;\">" + z + "</div>" + "<div class=\"s3dPointSelectorItemCell s3dPointSelectorItemBezier\" style=\"width:50px;\"><input type=\"checkbox\" class=\"s3dPointSelectorItemIsCurve\" " + (p.point.isCurve ? "checked=\"checked\"" : "") + " /></div>" + "</div>";
  };
...
export { S3dPointSelector as default };
