import { msgBox, s3dNormalViewport, cmnPcr, serverAccess, s3dUiStatus } from '../../commonjs/common/common.js';
import './s3dHouse2DToolbar.css.js';
...
let S3dHouse2DToolbar = function () {
  ...
  this.init = function (p) {
    ...
    thatS3dHouse2DToolbar.objectTypeConfig = p.config.objectTypeConfig;
  ...
  //隐藏
  this.hide = function () {
    $("#" + thatS3dHouse2DToolbar.containerId).find(".s3dHouse2DToolbarContainer").css({
      "display": "none"
    });
  };
  ...
  this.saveModel = function () {
    ...
    s3dObject.objectMap = thatS3dHouse2DToolbar.manager.viewer.getResultObjectMap();
    s3dObject.objectTypeMap = thatS3dHouse2DToolbar.manager.viewer.getResultObjectTypeMap();
  ...
  this.drawRoom2D = function () {
    ...
    if (objectIds.length === 0) {
      ...
      if (info.code.startsWith(thatS3dHouse2DToolbar.objectTypeConfig.room2D.categoryCode)) {
        //转为draw状态
        thatS3dHouse2DToolbar.manager.viewer.changeStatus({
          status: s3dUiStatus.draw
        });
        thatS3dHouse2DToolbar.manager.pathDrawingTool.show({
          id: info.id,
          pointStr: info.parameters["点"].value,
          lineStr: info.parameters["线"].value,
          constraintStr: info.parameters["约束"].value,
          pathStr: info.parameters["路径"].value
        });
      } else {
        msgBox.alert({
          info: "请选择房间"
  ...
  this.generateWall2D = function () {
    //根据房间构造轮廓参数
    let parameters = {};
    let allRoomObject3Ds = thatS3dHouse2DToolbar.manager.viewer.getObject3DsByCodePrefix(thatS3dHouse2DToolbar.objectTypeConfig.room2D.categoryCode);
    if (allRoomObject3Ds.length > 0) {
      ...
      for (let i = 0; i < allRoomObject3Ds.length; i++) {
        ...
        let info = roomObject3D.userData.info;
        let roomPolygonStr = info.parameters["轮廓"].value;
    ...
    //删除原有的墙
    let wallObject3Ds = thatS3dHouse2DToolbar.manager.viewer.getObject3DsByCodePrefix(thatS3dHouse2DToolbar.objectTypeConfig.wall2D.categoryCode);
    if (wallObject3Ds.length > 0) {
      if (!msgBox.confirm({
        ...
        for (let i = 0; i < wallObject3Ds.length; i++) {
          ...
          objectIds.push(wallObject3D.userData.info.id);
        }
        thatS3dHouse2DToolbar.manager.viewer.removeObjects(objectIds, false);
      }
    }
    let groupId = thatS3dHouse2DToolbar.manager.treeEditor.getCurrentGroupId();
    thatS3dHouse2DToolbar.manager.viewer.addNewServerObject({
      name: "墙",
      position: [0, 0, 0],
      rotation: [0, 0, 0],
      scale: [1, 1, 1],
      code: thatS3dHouse2DToolbar.objectTypeConfig.wall2D.defaultCode,
      versionNum: thatS3dHouse2DToolbar.objectTypeConfig.wall2D.defaultVersionNum,
      isOnGround: false,
  ...
  this.getResizeBtnHtml = function (closed) {
    if (closed) {
      return "<div class=\"s3dHouse2DToolbarResizeBtn\" title=\"最小化工具栏\" status=\"normal\"><svg xmlns=\"http://www.w3.org/2000/svg\" class=\"s3dHouse2DToolbarBtnSvg\" width=\"16\" height=\"16\">" + "<line x1=\"2\" y1=\"7\" x2=\"14\" y2=\"7\" class=\"s3dHouse2DToolbarResizeBtnLine\" />" + "<line x1=\"2\" y1=\"8\" x2=\"14\" y2=\"8\" class=\"s3dHouse2DToolbarResizeBtnLine\" />" + "</svg></div>";
    } else {
      return "<div class=\"s3dHouse2DToolbarResizeBtn\" title=\"还原工具栏\" status=\"min\"><svg xmlns=\"http://www.w3.org/2000/svg\" class=\"s3dHouse2DToolbarBtnSvg\" width=\"16\" height=\"16\">" + "<line x1=\"2\" y1=\"5\" x2=\"14\" y2=\"5\" class=\"s3dHouse2DToolbarResizeBtnLine\" />" + "<line x1=\"2\" y1=\"11\" x2=\"14\" y2=\"11\" class=\"s3dHouse2DToolbarResizeBtnLine\" />" + "<line x1=\"2\" y1=\"5\" x2=\"2\" y2=\"11\" class=\"s3dHouse2DToolbarResizeBtnLine\" />" + "<line x1=\"14\" y1=\"5\" x2=\"14\" y2=\"11\" class=\"s3dHouse2DToolbarResizeBtnLine\" />" + "</svg></div>";
    }
  };

  //获取list html
  this.getListHtml = function () {
    let roomBtnHtml = "<div class=\"s3dHouse2DToolbarBtnContainer\" title=\"绘制房间轮廓\" name=\"drawRoom2D\">" + "<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"s3dHouse2DToolbarBtnSvg\" width=\"32\" height=\"32\">" + "<line x1=\"5\" y1=\"5\" x2=\"16\" y2=\"5\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"16\" y1=\"5\" x2=\"16\" y2=\"12\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"16\" y1=\"12\" x2=\"27\" y2=\"12\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"27\" y1=\"12\" x2=\"27\" y2=\"27\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"27\" y1=\"27\" x2=\"5\" y2=\"27\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"5\" y1=\"27\" x2=\"5\" y2=\"5\" class=\"s3dHouse2DToolbarBtnLine\" />" + "</svg>" + "</div>";
    let wallBtnHtml = "<div class=\"s3dHouse2DToolbarBtnContainer\" title=\"自动生成墙\" name=\"generateWall2D\">" + "<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"s3dHouse2DToolbarBtnSvg\" width=\"32\" height=\"32\">" + "<line x1=\"5\" y1=\"5\" x2=\"27\" y2=\"5\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"5\" y1=\"27\" x2=\"27\" y2=\"27\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"5\" y1=\"5\" x2=\"5\" y2=\"27\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"27\" y1=\"5\" x2=\"27\" y2=\"27\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"5\" y1=\"12\" x2=\"27\" y2=\"12\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"5\" y1=\"20\" x2=\"27\" y2=\"20\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"10\" y1=\"5\" x2=\"10\" y2=\"12\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"22\" y1=\"5\" x2=\"22\" y2=\"12\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"16\" y1=\"12\" x2=\"16\" y2=\"20\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"10\" y1=\"20\" x2=\"10\" y2=\"27\" class=\"s3dHouse2DToolbarBtnLine\" />" + "<line x1=\"22\" y1=\"20\" x2=\"22\" y2=\"27\" class=\"s3dHouse2DToolbarBtnLine\" />" + "</svg>" + "</div>";
    ...
    let spliterHtml = "<div class=\"s3dHouse2DToolbarBtnSplitter\">" + "<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"s3dHouse2DToolbarBtnSvg\" width=\"32\" height=\"32\">" + "<line x1=\"3\" y1=\"0\" x2=\"3\" y2=\"32\" class=\"s3dHouse2DToolbarBtnSplitterLineA\" />" + "<line x1=\"4\" y1=\"0\" x2=\"4\" y2=\"32\" class=\"s3dHouse2DToolbarBtnSplitterLineB\" />" + "</svg>" + "</div>";
    return "<div class=\"s3dHouse2DToolbarContainer\">" + "<div class=\"s3dHouse2DToolbarBackground\"></div>" + "<div class=\"s3dHouse2DToolbarHeader\">" + "<div class=\"s3dHouse2DToolbarTitle\"></div>"

    //不可关闭
    //+ "<div class=\"s3dHouse2DToolbarCloseBtn\">×</div>"
    + "</div>" + "<div class=\"s3dHouse2DToolbarInnerContainer\">" + "<div class=\"s3dHouse2DToolbarInnerLine\">" + topViewportBtnHtml + rulerBtnHtml + spliterHtml + treeBtnHtml + propertyBtnHtml + componentListBtnHtml + statusBarBtnHtml + "</div>" + "<div class=\"s3dHouse2DToolbarInnerLine\">" + roomBtnHtml + wallBtnHtml + spliterHtml + settingBtnHtml + spliterHtml + saveBtnHtml + "</div>" + "</div>" + "</div>";
  };
};

export { S3dHouse2DToolbar as default };
