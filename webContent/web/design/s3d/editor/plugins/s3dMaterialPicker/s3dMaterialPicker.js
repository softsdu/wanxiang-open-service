import { s3dUiStatus, cmnPcr } from '../../commonjs/common/common.js';
import './s3dMaterialPicker.css.js';
...
let S3dMaterialPicker = function () {
  ...
  this.getListHtml = function (p) {
    let html = "<div class=\"s3dMaterialPickerContainer\">" + "<div class=\"s3dMaterialPickerHeader\">" + "<div class=\"s3dMaterialPickerHeader\">" + "<div class=\"s3dMaterialPickerTitle\"></div>" + "<div class=\"s3dMaterialPickerSubTitle\"></div>" + "<div class=\"s3dMaterialPickerBtn s3dMaterialPickerCloseBtn\" title=\"关闭\">×</div>" + "</div>" + "<div class=\"s3dMaterialPickerInnerContainer\">";
    for (let i = 0; i < thatS3dMaterialPicker.manager.materials.materialList.length; i++) {
      let materialInfo = thatS3dMaterialPicker.manager.materials.materialList[i];
    ...
    html += "</div>" + "<div class=\"s3dMaterialPickerBottomContainer\">" + "<div class=\"s3dMaterialPickerBottomBtn s3dMaterialPickerBtnCancel\">取&nbsp;&nbsp;消</div>" + "<div class=\"s3dMaterialPickerBottomBtn s3dMaterialPickerBtnOk\">确&nbsp;&nbsp;定</div>" + "</div>" + "</div>";
    return html;
  };

  //构造材质条目html
  this.getItemHtml = function (p) {
    let html = "<div class=\"s3dMaterialPickerItemContainer" + (p.selected ? " s3dMaterialPickerItemContainerActive" : "") + "\" materialName=\"" + p.name + "\">" + "<div class=\"s3dMaterialPickerItemCell s3dMaterialPickerItemName\">" + p.name + "</div>" + "<div class=\"s3dMaterialPickerItemCell s3dMaterialPickerItemColor\" style=\"background-color:" + cmnPcr.getColorStr(p.color) + "\">&nbsp;</div>" + "<div class=\"s3dMaterialPickerItemCell s3dMaterialPickerItemOpacity\">" + p.opacity + "%</div>" + "</div>";
    return html;
  };
...
export { S3dMaterialPicker as default };
