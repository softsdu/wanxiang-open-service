...
let S3dToolbar = function () {
  ...
  //隐藏
  this.hide = function () {
    $("#" + thatS3dToolbar.containerId).find(".s3dToolbarContainer").css({
      "display": "none"
    });
  };
  ...
  this.getButtonHtml = function (buttonJson) {
    return "<div class=\"s3dToolbarBtnContainer\" buttonId=\"" + buttonJson.id + "\" title=\"" + cmnPcr.htmlEncode(buttonJson.name) + "\">" + ("<img class=\"s3dToolbarBtnImg\" src=\"" + buttonJson.imgUrl + "\" />") + "</div>";
  };
};

export { S3dToolbar as default };
