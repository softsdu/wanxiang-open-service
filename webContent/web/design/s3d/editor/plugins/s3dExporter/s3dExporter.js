...
let S3dExporter = function () {
  ...
  //隐藏
  this.hide = function () {
    $("#" + thatS3dExporter.containerId).find(".s3dExporterContainer").css({
      "display": "none"
    });
  };
  ...
  this.show = function () {
    ...
    $(container).find(".s3dExporterContainer").css({
      "display": "block"
    });
  };
  ...
  this.getWinHtml = function () {
    return "<div class=\"s3dExporterContainer\">" + "<div class=\"s3dExporterBackground\"></div>" + "<div class=\"s3dExporterOuterContainer\">" + "<div class=\"s3dExporterHeader\">" + "<div class=\"s3dExporterTitle\"></div>" + "<div class=\"s3dExporterCloseBtn\">×</div>" + "</div>" + "<div class=\"s3dExporterInnerContainer\">" + "<div class=\"s3dExportButton\" name=\"exportS3dFile\">" + "<div class=\"s3dExporterText\">S3Dc文件</div>" + "<div class=\"s3dExporterSubText\">文件小，可以使用S3DWeb打开/编辑</div>" + "</div>" + "<div class=\"s3dExportButton\" name=\"exportGltfFile\">" + "<div class=\"s3dExporterText\">GLTF文件</div>" + "<div class=\"s3dExporterSubText\">通用格式，主流三维软件支持</div>" + "</div>" + "<div class=\"s3dExporterBottom\">" + "<div class=\"s3dExporterBottomText\"></div>" + "</div>" + "</div>" + "</div>" + "</div>";
  };
};

export { S3dExporter as default };
