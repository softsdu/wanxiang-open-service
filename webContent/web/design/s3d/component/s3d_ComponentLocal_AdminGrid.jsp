...
<head> 
	<title>S3D本地模型</title>
	<script type="text/javascript" src="${dataModel}/s3d_ComponentLocal.js"></script>
	<script type="text/javascript" src="${viewModel}/s3d_ComponentLocalAdmin.js"></script>
	...
	<script>
		...
		$(document).ready(function(){
			let p = {
				...
				multiselect: true,
				dataModel: dataModels.s3d_ComponentLocal,
				onePageRowCount: 20,
				isRefreshAfterSave: false,
				viewModel: viewModels.s3d_ComponentLocalAdmin
			};
