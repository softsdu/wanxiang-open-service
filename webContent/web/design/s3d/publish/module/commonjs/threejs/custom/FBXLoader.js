import { Vector3, Loader, LoaderUtils, FileLoader, TextureLoader, RepeatWrapping, ClampToEdgeWrapping, Texture, MeshPhongMaterial, MeshLambertMaterial, ColorManagement, Color, SRGBColorSpace, EquirectangularReflectionMapping, Matrix4, Group, Bone, PropertyBinding, Object3D, PerspectiveCamera, PointLight, MathUtils, SpotLight, DirectionalLight, SkinnedMesh, Mesh, LineBasicMaterial, Line, Skeleton, AmbientLight, BufferGeometry, Float32BufferAttribute, Uint16BufferAttribute, Matrix3, Vector2, ShapeUtils, Vector4, AnimationClip, Quaternion, VectorKeyframeTrack, Euler, QuaternionKeyframeTrack, NumberKeyframeTrack } from '../../../node_modules/three/build/three.module.js';
import { unzlibSync } from '../../../node_modules/three/examples/jsm/libs/fflate.module.js';
...
class FBXTreeParser {
  ...
  getTransformData(model, modelNode) {
    ...
    if ('RotationOrder' in modelNode) transformData.eulerOrder = getEulerOrder(modelNode.RotationOrder.value);else transformData.eulerOrder = getEulerOrder(0);
