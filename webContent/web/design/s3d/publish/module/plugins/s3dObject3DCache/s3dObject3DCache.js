...
let S3dObject3DCache = function () {
  ...
  this.addRefComponentObject3D = function (cacheKey, object3D, geoJson, sameObjectId, objectSetting, box, helperObject3D) {
  ...
  this.cloneHelperObject3D = function (cacheKey) {
    let cacheObj = thatS3dObject3DCache.refComponentObject3Ds[cacheKey];
    let newHelperObject3D = cacheObj.helperObject3D.clone();
    thatS3dObject3DCache.cloneObject3DGeometry(newHelperObject3D, cacheObj.helperObject3D);
    return newHelperObject3D;
  };
  this.getObjectSetting = function (cacheKey) {
    let cacheObj = thatS3dObject3DCache.refComponentObject3Ds[cacheKey];
    return cacheObj.objectSetting;
  };
  ...
  this.addResourceObject3D = function (cacheKey, object3D, assistInfo, materialInfo, hasError) {
  ...
  this.cloneResourceObject3D = function (cacheKey, hasError) {
    let cacheObj = thatS3dObject3DCache.resourceObject3Ds[cacheKey];
    return cacheObj.object3D.clone();
  };
  this.getHasError = function (cacheKey) {
    return thatS3dObject3DCache.resourceObject3Ds[cacheKey].hasError;
  };
  this.clonePartSourceObject3D = function (cacheKey, partName, hasError) {
    let cacheObj = thatS3dObject3DCache.resourceObject3Ds[cacheKey];
  ...
  this.cloneObject3DGeometry = function (object3D, oldObject3D) {
    if (object3D.children != null) {
      for (let i = 0; i < object3D.children.length; i++) {
        ...
        //线
        if (oldChildObj.isObjectLine) {
          childObj.isObjectLine = oldChildObj.isObjectLine;
        }
        ...
        //resource本身
        if (oldChildObj.isResourceObject) {
          childObj.isResourceObject = oldChildObj.isResourceObject;
        }
...
export { S3dObject3DCache as default };
