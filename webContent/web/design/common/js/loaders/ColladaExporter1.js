/**
 * 本文件为r95版本，也是第一个版本；
 * r93无此文件；  20221114 added by liyh
 *
...
THREE.ColladaExporter.prototype = {
    ...
    parse: function ( object, onDone, options = {} ) {
        ...
        function processGeometry( g ) {
            ...
            //if ( meshid == null ) {
            if ( meshid == null && processGeom.attributes.position) {
                ...
                var indexCount =
                    processGeom.index ?
                        processGeom.index.count * processGeom.index.itemSize :
                        processGeom.attributes.position? processGeom.attributes.position.count:0;
        ...
        if ( typeof onDone === 'function' ) {
            ...
            requestAnimationFrame( () => onDone( dae.replace(/[\'\"\\\/\b\f\n\r\t]/g, '')) );
