//编辑pathClosed3d added by ls 20230112
js3CommandProcessors["pathClosed3d"] = {
	toStatus: "normal",	
	editor: null,
	intervalId: null,
	paramName: null,
	...
	run: function(p){
		var thatCommandJson = js3CommandProcessors["pathClosed3d"];
	...
	showLayoutPath3dWindow: function(p){ 
		...
		js3CommandProcessors["pathClosed3d"].intervalId = setInterval(function(){
