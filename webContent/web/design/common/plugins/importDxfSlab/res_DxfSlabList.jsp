...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/res_DxfSlab.js"></script>
	<script type="text/javascript" src="${viewModel}/res_DxfSlab.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			dataModel:dataModels.res_DxfSlab,
			onePageRowCount:20, 
			viewModel:viewModels.res_DxfSlab,
		...
		var closePop = function(rows){
			...
			if(rows != null){
				...
				if(!validated){
					msgBox.alert({info: "该图纸尚未解析成功, 请先执行解析操作."});
					return;
				}
			}			
