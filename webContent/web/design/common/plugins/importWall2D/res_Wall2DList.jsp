...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/res_Wall2D.js"></script>
	<script type="text/javascript" src="${viewModel}/res_Wall2D.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			dataModel:dataModels.res_Wall2D,
			onePageRowCount:20, 
			viewModel:viewModels.res_Wall2D,
