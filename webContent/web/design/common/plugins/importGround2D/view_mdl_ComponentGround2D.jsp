...
<head> 
	...
	$(document).ready(function(){ 
		...
		var pMdlCom = { 
			...
			//增加展示字段
			cardImgField:"imgid",
			cardDivTitleField:"name",
		};
		grid = new NcpViewCard(pMdlCom);
        ...
        grid.initCardListHtml=function (param){
            ...
            for (var rowId in this.datatable.allRows()) {
                ...
                var oneHtml=" <div id='"+rowId+"' style=\"width: 165px; box-sizing: border-box; margin: 5px; position: relative;\"> " +
		...
		grid.sysWhere = [{parttype:"field", field: "mdltype", operator:"=", value: "gds"}];
		tree.treeGridCtrl.sysWhere = [{parttype:"field", field: "mdltype", operator:"=", value: "gds"}];
