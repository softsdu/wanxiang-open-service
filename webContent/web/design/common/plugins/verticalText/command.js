//添加距离标注 added by ls 20220606
js3CommandProcessors["verticalText"] = {
	toStatus: "normal",	
	componentCode: "993010-02",
	componentVersionNum: "1.0",
	icon: "/images/verticalText.png",
	run: function(p){ 
		var editor = p.editor;
		var commandProcessor = js3CommandProcessors["verticalText"];
		var valueParameters = {}; 
