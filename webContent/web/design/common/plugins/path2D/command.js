//编辑path2d added by ls 20230109
js3CommandProcessors["path2d"] = {
	toStatus: "normal",	
	editor: null,
	intervalId: null,
	paramName: null,
	...
	run: function(p){
		var thatCommandJson = js3CommandProcessors["path2d"];
	...
	showLayoutPath2dWindow: function(p){ 
		...
		js3CommandProcessors["path2d"].intervalId = setInterval(function(){
