...
<html>
	<head>
		...
		let sourceComponentInfo = window.parent.js3CommandProcessors["exportS3Dc"].sourceComponentInfo;
		let canExplodeItemTree = window.parent.js3CommandProcessors["exportS3Dc"].canExplodeItemTree;
