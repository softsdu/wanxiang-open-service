package com.zlp.external.resource.image.service;

import com.zlp.external.resource.image.processor.ImageProcessor;
...
public class GetImage extends HttpServlet{    
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {  
        ...
        try { 
    		NcpSession session = new NcpSession(request.getCookies(), true);
    		imgProcessor = (ImageProcessor)ContextUtil.getBean("resImageProcessor");
            ...
            if(accessoryId != null){
                ...
                byte[] data = this.getImageDataByName(session.getUserId(), imgProcessor, name);
                this.writeResponse(imgProcessor, response, data);
            }
        }
        catch (Exception e) { 
    ...
    private byte[] getImageDataByName(String userId, ImageProcessor kgProcessor, String imageName) throws Exception{
        String imageFilePath = kgProcessor.getImagePathByName(userId, imageName);
